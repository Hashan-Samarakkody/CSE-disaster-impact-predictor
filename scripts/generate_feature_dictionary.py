...
ROWS = [
    ...
    ("fx_logret_1", "Macro/Global", "External (FRED, DEXSLUS)", "1-day USD/LKR log return, computed strictly at/before t-1.",
     ...
     "docs/audit.md Part 3 Block C: 'an annual macro control against a day-0 event is indefensible, and replacing it is a correctness fix, not a performance lever.' Pre-declared expectation: 'expected to do little on its own.'"),
    ...
    ("hz_districts_wet", "Hazard (measured)", "External (NASA POWER)", "Count of districts exceeding 50mm/3-day rainfall.",
     ...
     "Sri Lanka Department of Meteorology operational threshold (cited in docs/audit.md Part 3 Block A)."),
    ...
    ("di_records", "Physical Severity", "External (DesInventar/UNDRR)", "Count of DesInventar records in the matched window.",
     ...
     "docs/audit.md Part 3 Block B, explicit interpretive caveat."),
