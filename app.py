...
st.set_page_config(page_title="CSE Disaster Impact Predictor", layout="wide", page_icon="📉")
...
def _highlight(row):
    colour = "background-color: rgba(30,158,107,0.15)" if row["Beats baseline?"].startswith("✓") \
